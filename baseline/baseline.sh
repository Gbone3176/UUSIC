...
#     --master_port=12345 \
#     omni_train_PG.py \
#     --output_dir=exp_out/trail_debug_15 \
#     --prompt \
#     --base_lr=0.00001 \
#     --batch_size=128 \
#     --max_epochs=800 \
#     --root_path=/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/challenge-main/baseline/data/ \
#     --resume=/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/challenge-main/baseline/exp_out/trail_debug_14/latest_699.pth \
