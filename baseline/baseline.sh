...
#     --master_port=12345 \
#     omni_train_PG.py \
#     --output_dir=exp_out/trail_debug_32 \
#     --prompt \
#     --base_lr=0.00001 \
#     --batch_size=128 \
#     --max_epochs=1000 \
#     --root_path=/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/challenge-main/baseline/data/ \
    # --resume=/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/challenge-main/baseline/exp_out/trail_debug_31_2/latest.pth \
...
torchrun \
    ...
    --master_port=2345 \
    omni_test_PG.py \
    --output_dir=exp_out/test_trail_debug_32 \
    --prompt \
    --base_lr=0.00001 \
    --batch_size=1 \
    --max_epochs=400 \
    --root_path=/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/challenge-main/baseline/data/ \
    --resume=/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/challenge-main/baseline/exp_out/trail_debug_32/best_model_179_0.7568.pth \
