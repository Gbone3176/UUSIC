    ...
    for dataset_name in cls_test_set:
        ...
        for i_batch, sampled_batch in tqdm(enumerate(testloader)):
            ...
            if num_classes == 4:
                ...
                logits = output[1]
            properbility = torch.softmax(logits, dim=1)
            print(properbility)
...
if __name__ == "__main__":
    ...
    snapshot = "/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/challenge-main/baseline/exp_out/trial_uusic_5/best_model_59_0.3359.pth"
